                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div
                                            ...
                                            <div>
                                                <h5 class="d-flex justify-content-center mt-5">if you want to test it</h5>
                                                <form class="d-flex justify-content-center mt-5">
                                                    <div class="form-group">
                                                      <label for="exampleInputEmail1">Email address</label>
                                                      <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly value="{{ $project->email}}">
                                                      {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                                                    </div>
                                                    <div class="form-group">
                                                      <label for="exampleInputPassword1">Password</label>
                                                      <input type="text" class="form-control" id="exampleInputPassword1" readonly value="{{ $project->password }}">
                                                    </div>
                                                  </form>
                                            </div>
                                        </div>
